					...
					fetch(url)
						...
						.then(function (jsonResult) {
							...
							app.displayResult(
								...
								app.synonyms,
								app.images
								// May need to add audio source here
							);
						});
				});
		});
...
app.displayResult = function (definitionArray, synonymsArray, imageArray) {
	...
	app.audioURL = `https://media.merriam-webster.com/audio/prons/en/us/mp3/p/${app.desiredWord}.mp3`;
	...
	let defH3 = document.createElement("h3");
	defH3.innerHTML = "Definitions:";
	definitionsSection.prepend(defH3);

	const definitionsList = document.querySelector(".definitionsList");

	const synonymsSection = document.querySelector(".synonyms");
	let synH3 = document.createElement("h3");
	synH3.innerHTML = "Synonyms:";
	synonymsSection.prepend(synH3);
